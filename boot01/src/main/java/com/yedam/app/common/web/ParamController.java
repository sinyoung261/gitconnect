...
public class ParamController {
	...
	(@RequestParam Integer employeeId, //필수 //공백 널 값 처리 가능 int 사용시 공백 널 값 처리 불가능
					String lastName,   //생략가능
	@RequestParam(name="message", //클라이언트 접근키, 다르게 사용할 시 적용
				  defaultValue="No message", //대신할 기본값
	...
	//@PathBariable : 경로에 값을 포함하는 방식, 단일 값
	//Content-type도 상관없음
	//Method도 상관없음
